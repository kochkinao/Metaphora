...
async def pic1(msg:types.Message):
    ...
    await msg.answer('На этом этапе важно верно проанализировать, как эта карта отвечает на твой вопрос. Для этого нужно сконцентрироваться на своих ассоциациях. В моей инструкции я собрала ряд вопросов, которые тебе могут помочь. ',
                     reply_markup=kb.tg)
